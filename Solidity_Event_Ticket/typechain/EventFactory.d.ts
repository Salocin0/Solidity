...
interface EventFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "createEvent(string,string,uint256)": FunctionFragment;
...
export class EventFactory extends BaseContract {
  ...
  estimateGas: {
    ...
    getEvent(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
