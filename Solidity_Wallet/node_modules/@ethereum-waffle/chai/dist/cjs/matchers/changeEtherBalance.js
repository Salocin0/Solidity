...
async function getBalanceChange(transaction, account, options) {
    ...
    const balanceAfter = await account.provider.getBalance((0, account_1.getAddressOf)(account), txBlockNumber);
    const balanceBefore = await account.provider.getBalance((0, account_1.getAddressOf)(account), txBlockNumber - 1);
