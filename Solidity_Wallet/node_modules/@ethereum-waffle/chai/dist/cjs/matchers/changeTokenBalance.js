...
async function getBalanceChange(transactionCall, token, account) {
    const balanceBefore = await token['balanceOf(address)'](await (0, account_1.getAddressOf)(account));
    await transactionCall();
    const balanceAfter = await token['balanceOf(address)'](await (0, account_1.getAddressOf)(account));
