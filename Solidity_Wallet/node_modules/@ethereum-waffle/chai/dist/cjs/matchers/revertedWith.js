    ...
    Assertion.addMethod('revertedWith', function (revertReason) {
        ...
        const onSuccess = (value) => {
            if ('wait' in value) {
                ...
                return value.wait().then((newValue) => newValue, onError);
            }
        ...
        const onError = (error) => {
            var _a, _b;
            const revertString = (_b = (_a = error === null || error === void 0 ? void 0 : error.receipt) === null || _a === void 0 ? void 0 : _a.revertString) !== null && _b !== void 0 ? _b : (0, provider_1.decodeRevertString)(error);
            if (revertString) {
                this.assert(revertString === revertReason, `Expected transaction to be reverted with ${revertReason}, but other reason was found: ${revertString}`, `Expected transaction NOT to be reverted with ${revertReason}`, `Transaction reverted with ${revertReason}.`, error);
                return error;
            }
