...
class MockProvider extends ethers_1.providers.Web3Provider {
    ...
    getWallets() {
        var _a, _b, _c;
        const items = (_c = (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.ganacheOptions.wallet) === null || _b === void 0 ? void 0 : _b.accounts) !== null && _c !== void 0 ? _c : defaultAccounts_1.defaultAccounts;
