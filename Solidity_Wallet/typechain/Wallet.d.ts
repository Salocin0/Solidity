...
export type LogWithdrawToEvent = TypedEvent<[string] & { Wallet: string }>;
...
export class Wallet extends BaseContract {
  ...
  callStatic: {
    ...
    withdraw(_balance: BigNumberish, overrides?: CallOverrides): Promise<void>;
